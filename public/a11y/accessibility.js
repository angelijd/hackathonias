...
document.addEventListener('DOMContentLoaded', function() {
  ...
  menu.innerHTML = '<button class="ias-a11y-btn" id="ias-btn-contrast">👁️ Modo Adaptado (Alto Contraste)</button>' +
  ...
  if (btnContrast) {
    btnContrast.addEventListener('click', function() {
      ...
      btnContrast.innerHTML = document.body.classList.contains('ias-a11y-mode') ? 
        '👁️ Desativar Modo Adaptado' : '👁️ Modo Adaptado (Alto Contraste)';
    });
  }
