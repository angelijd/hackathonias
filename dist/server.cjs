...
4. **Seguran\xC3\xA7a e Foco**:
  ...
  const sennaLoginDist = import_path.default.join(process.cwd(), "../SennaLogin/dist");
  const sennaTesteDist = import_path.default.join(process.cwd(), "../Senna/dist");
  const autoavaliacaoDist = import_path.default.join(process.cwd(), "../autoavaliacao/dist");
  const hackathonDist = import_path.default.join(process.cwd(), "../hackathoniascpc-main/dist");
  ...
  app.get("/", (req, res) => {
    res.send(`
      ...
      <body>
        <div class="container">
          <span style="font-size: 11px; font-weight: 800; color: #FBB800; text-transform: uppercase; letter-spacing: 2px;">Instituto Ayrton Senna</span>
          <h1>Portal Integrado de Compet\xEAncias</h1>
          <p>Selecione abaixo o m\xF3dulo que deseja acessar. Cada projeto est\xE1 isolado em sua pr\xF3pria sandbox e roda em sua pr\xF3pria rota est\xE1tica dedicada.</p>
          
          <div class="grid">
            <a href="/login/" class="card">
              <div>
                <div class="icon">\u{1F3DB}\uFE0F</div>
                <h3>Logins & Dashboards</h3>
                <div class="desc">Acesso para Educadores, Gestores e Estudantes. Cont\xE9m os gr\xE1ficos de turmas, sugest\xF5es da BNCC e recupera\xE7\xE3o real de senha.</div>
              </div>
              <span class="link">Acessar portal &rarr;</span>
            </a>
            ...
            <a href="/teste/" class="card">
              <div>
                ...
                <h3>Senna Teste</h3>
                <div class="desc">Diagn\xF3stico socioemocional original composto por 15 quest\xF5es fixas com Devolutiva baseada em arqu\xE9tipos de personagens de s\xE9ries.</div>
              </div>
              <span class="link">Acessar portal &rarr;</span>
            </a>
            ...
            <a href="/autoavaliacao/" class="card">
              <div>
                ...
                <h3>Autoavalia\xE7\xE3o</h3>
                <div class="desc">Question\xE1rio composto por 19 perguntas de autoavalia\xE7\xE3o contendo vinhetas situacionais de Aline, Juliana, Sofia e Marcos.</div>
              </div>
              <span class="link">Acessar portal &rarr;</span>
            </a>
            ...
            <a href="/hackathon/" class="card">
              <div>
                ...
                <h3>Criatividade & Cr\xEDtico</h3>
                <div class="desc">Teste din\xE2mico e adaptativo que gera enunciados via IA do Gemini e oferece um relat\xF3rio detalhado integrado com o rob\xF4 B\xE9co.</div>
              </div>
              <span class="link">Acessar portal &rarr;</span>
            </a>
          </div>
