...
export const FIXED_QUESTIONS = [
  'Gosto de atividades artísticas',
  'Descobrir como algo funciona',
  'Criar e escrever histórias',
  'Gosto de conhecer lugares e costumes diferentes dos meus',
  'Manter-se organizado quando tem muitas coisas para fazer',
  'Terminar todo o dever de casa',
  'Guardar as coisas no lugar certo',
  'Esforçar-se nos estudos quando tem uma prova difícil',
  'Sempre me distraio com brincadeiras quando estou na sala de aula',
  'Não sou uma pessoa muito empolgada',
  'Pedir ajuda aos professores quando tem dificuldades',
  'Colocar o esforço e o tempo necessários nas suas tarefas para obter bons resultados',
  'Gosto de puxar conversa com quem acabei de conhecer',
  'Costumo defender a minha opinião mesmo quando a maioria pensa diferente',
  'Prefiro ficar quieto quando estou em grupo',
];
